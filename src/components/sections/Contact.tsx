        ...
        >
          ...
          <ContactContent role="article">
            <ContactText 
              ...
              role="paragraph"
            >
              Me interesa conocer más sobre nuevos proyectos y oportunidades.
              ¡Siéntete en la libertad de preguntar o simplemente saludar cuando quieras!
            </ContactText>
            <ContactEmail 
              href="mailto:robertonajeratics@gmail.com"
              variants={itemVariants}
            ...
            >
              ...
              <span>robertonajeratics@gmail.com</span>
            </ContactEmail>
            <SocialLinks 
              variants={itemVariants}
              role="list"
            ...
            >
              ...
              <SocialLink 
                href="https://www.linkedin.com/in/roberto-samuel-najera-marroquin-3249b9263/" 
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ y: -5 }}
                role="listitem"
              ...
              <SocialLink 
                href="https://x.com/TruthSeeker2378"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ y: -5 }}
                role="listitem"
